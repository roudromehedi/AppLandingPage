...
const navbar = {
  ...
  button: { btnLogin: "Log in", btnGetStarted: "Get started" },
  items: ["Home", "Company", "Marketplace", "Features", "Team", "Contact"],
};
</script>
<template>
  <header>
    <nav class="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
      ...
      >
        <a :href="navbar.logo.website" class="flex items-center">
          <img
